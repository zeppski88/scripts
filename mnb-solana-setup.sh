#
# Last update 23/08/2022  version 1.10.35
#
...
curl -sSf https://raw.githubusercontent.com/solana-labs/solana/v1.10.35/install/solana-install-init.sh | sh -s - v1.10.35
